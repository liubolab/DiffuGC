...
class SineDataset(Dataset):
    def __init__(
        ...
        #                                          seed=seed, dir=self.dir, period=period) # 原来的，(10000,24,5)
        
        self.rawdata = np.load('/data/0shared/liubo/diffusion-gc/Diffusion-TS-main/Data/var_data.npy')  # (1000,24,10)
